...
import { ArrowRight, TrendingUp, DollarSign, Globe, Target } from "lucide-react"
    ...
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Lens Organics investment opportunity"
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="font-serif font-black text-4xl md:text-6xl lg:text-7xl mb-8 leading-tight">
            Investment &<span className="text-emerald-400 block">Partnership</span>
          ...
          <p className="text-lg md:text-xl mb-10 text-gray-200 max-w-4xl mx-auto leading-relaxed">
            Join us in revolutionizing Uganda's agricultural sector. Lens Organics offers proven operations, premium
            products, and exceptional growth potential in the rapidly expanding natural products market. We're seeking
            strategic partners and investors to scale our integrated agricultural enterprise.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10 max-w-5xl mx-auto">
            <div className="glass-card p-6 rounded-xl">
              <h3 className="font-semibold text-lg mb-2 text-emerald-400">UGX 3.7B-11B Revenue</h3>
              <p className="text-sm text-gray-300">Projected annual revenue within 3 years</p>
            </div>
            <div className="glass-card p-6 rounded-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="#contact-investors">Schedule Meeting</Link>
            </Button>
          </div>
        </div>
      </div>
